package io.sharedstreets.proto;

// Generated by the protocol buffer compiler.  DO NOT EDIT!
// source: proto/geobuf/geobuf.proto
  ...
  public  static final class Data extends
      ...
      protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
          ...
          case VISIT: {
            ...
            Geobuf.Data.Feature other = (Geobuf.Data.Feature) arg1;
              ...
              while (!done) {
                ...
                switch (tag) {
                  ...
                  case 106: {
                    ...
                    values_.add(
                            input.readMessage(Geobuf.Data.Value.parser(), extensionRegistry));
                    break;
                  }
                  case 112: {
                    if (!properties_.isModifiable()) {
          ...
          case GET_PARSER: {
            if (PARSER == null) {    synchronized (Geobuf.Data.Feature.class) {
              if (PARSER == null) {
    ...
    public  static final class Geometry extends
      ...
      protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
          ...
          case VISIT: {
            Visitor visitor = (Visitor) arg0;
            Geobuf.Data.Geometry other = (Geobuf.Data.Geometry) arg1;
              ...
              while (!done) {
                ...
                switch (tag) {
                  ...
                  case 8: {
                    ...
                    Geobuf.Data.Geometry.Type value = Geobuf.Data.Geometry.Type.forNumber(rawValue);
                    if (value == null) {
                  ...
                  case 34: {
                    ...
                    geometries_.add(
                            input.readMessage(Geobuf.Data.Geometry.parser(), extensionRegistry));
                    break;
                  }
                  case 106: {
                    if (!values_.isModifiable()) {
          ...
          case GET_PARSER: {
            if (PARSER == null) {    synchronized (Geobuf.Data.Geometry.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    public  static final class FeatureCollection extends
      ...
      protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
          ...
          case VISIT: {
            Visitor visitor = (Visitor) arg0;
            Geobuf.Data.FeatureCollection other = (Geobuf.Data.FeatureCollection) arg1;
              ...
              while (!done) {
                ...
                switch (tag) {
                  ...
                  case 10: {
                    ...
                    features_.add(
                            input.readMessage(Geobuf.Data.Feature.parser(), extensionRegistry));
                    break;
                  }
                  case 106: {
                    if (!values_.isModifiable()) {
          ...
          case GET_PARSER: {
            if (PARSER == null) {    synchronized (Geobuf.Data.FeatureCollection.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    public  static final class Value extends
      ...
      protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
          ...
          case VISIT: {
            Visitor visitor = (Visitor) arg0;
            Geobuf.Data.Value other = (Geobuf.Data.Value) arg1;
          ...
          case GET_PARSER: {
            if (PARSER == null) {    synchronized (Geobuf.Data.Value.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          Geobuf.Data other = (Geobuf.Data) arg1;
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 34: {
                  ...
                  dataType_ =
                          input.readMessage(Geobuf.Data.FeatureCollection.parser(), extensionRegistry);
                  if (subBuilder != null) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (Geobuf.Data.class) {
            if (PARSER == null) {
              PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
            }
          }
